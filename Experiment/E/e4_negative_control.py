...
활용: E1·E2 에서 관측된 Δg 를 이 곡선에 대입 → 실데이터 δ 의 오염 추정.
...
산출:  runs/E4/...  +  runs/E4/E4_summary.json (누출곡선)
"""
...
def run_frac(year, H1, H2, frac, reps, epochs, cache, root):
