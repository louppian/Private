...
# 확정: True (표적군 203 ROI 전수). 이 선택의 대가로 표적군 45명 중 27명은 3·4 가 아닌
# 영상이 2장 이하여서 전체 시퀀스가 그대로 제시된다 — §3.4 의 "환자 전체 시퀀스를
# 보여주지 않는다" 가 그 27명에는 성립하지 않으므로 plan 문구를 고쳐야 한다.
TARGET_FULL_ENUMERATION = True
